(function ($) {
    ...
    if($sliderActvation.length > 0){
        $sliderActvation.slick({
          prevArrow:'<button class="prev_arrow"><img src="img/icon/navigation-arrow2.webp" alt=""></button>',
          nextArrow:'<button class="next_arrow"><img src="img/icon/navigation-arrow1.webp" alt=""></button>',
        });
    };
